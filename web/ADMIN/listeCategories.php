...
<html>
    <head>
        ...
        <title>Categories|Liste-des-categories</title>
    </head>
    <body>
        <!--==============================header=================================-->
                    ...
                    <div class="col-md-12">
                     ...
                     <div style="width:300px;margin-top:1%">
                         <form action="ajoutCatFonction.php">
                             <input type="text" class="form-control" name="categorie" placeholder="nomCat"style="float:left;width:70%">
                                                        ...
                                                        <div class="modal-dialog">
                                                            ...
                                                            <div class="modal-content" style="background-color:#F1F1F4">
                                                              ...
                                                              <div class="modal-body" >
                                                                    <input type="hidden" name="idC" value="<?php echo  $listCt[0] ?>">
                                                                    <label style="padding-top: 4%;">Nom de la categorie</label>
                                                                    <input class="form-control" type="text" value="<?php echo  $listCt[1] ?>" name="nomCat">
                                                              </div>
                                                    ...
                                                    <div id="myModal<?php echo  $listCt[0] ?>" class="modal fade" role="dialog">
                                                      <div class="modal-dialog">
                                                        ...
                                                        <div class="modal-header" style="background-color:#23527c">
                                                          ...
                                                          <div class="modal-footer">
                                                              <a  href="suppcat.php?idCat=<?php echo  $listCt[0] ?>" class="btn btn btn-success" style="color:white;">Oui</a>
