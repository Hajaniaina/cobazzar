...
<html lang="en">
<head>
<title>Creer un compte | inscrire grtuitement sur le site CoBazzar</title>
...
<body>
	...
	<div class="login-page">
		<div class="container"> 
			<h1 class="w3ls-title w3ls-title1">Creer un compte</h1>  
			<div class="login-body">
				<form action="Redirection/RedirectionTraitementSignIn.php" method="post">
					<input type="text" class="user" name="name" placeholder="Votre nom" required="">
					<input type="text" class="user" name="email" placeholder="Votre mail" required="">
			...
			<h2 style="font-size: 20px">Vous avez deja un compte? <a href="Redirection/RedirectionLogin.php">Se connecter »</a> </h2>  
		</div>
	</div>
	<!-- //sign up-page --> 
	<!-- footer-top -->
