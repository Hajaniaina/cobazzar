...
<html lang="en">
<head>
<title>Offres-d-aujourd-hui-et-cartes-cadeaux : cobazzar</title>
...
<body>
	...
	<div class="wthree-offers">
		<div class="container">
			<h1 class="w3ls-title w3ls-title1">Offres d'aujourd'hui et cartes-cadeaux</h1>
			<div class="w3ls-add-grids w3agile-add-products">
				<a href="Listes&types-produits-6-1.bazzar"> 
					<h2>TOP 10 TENDANCES POUR VOUS PLAT<span>20%</span> OFF</h2>
					<h6>Achetez maintenant <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></h6>
				</a>
			</div> 
			<div class="offer-card-row">
				<div class="col-md-4 offer-card-grids">
					<h2>20% Remboursement </h2>
					<p>Boutique Utilisation de cartes-cadeaux Obtenez 20% Remboursement</p>
					<a href="Listes&types-produits-1-1.bazzar">Acheter maintenant <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
				</div>
				<div class="col-md-4 offer-card-grids">
					<h2>Gagner $20</h2>
					<p>Parrainez un ami et gagnez 20 $ dans Smart bazaar!</p>
					<a href="Listes&types-produits-2-1.bazzar">Acheter maintenant <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
				</div>
				<div class="col-md-4 offer-card-grids">
					<h2>10% Remboursement </h2>
					<p>Boutique utilisant la carte de crédit Obtenez 10% Remboursement </p>
					<a href="Listes&types-produits-3-1.bazzar">Acheter maintenant <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
				</div>	
